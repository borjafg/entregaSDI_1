...
public class Sesion3Tests {
    ...
    public void testInicioSesionUsuario() {//test básico hasta log in
    	...
    	mary.assertTextPresent("Identificador de usuario:");//comprobamos texto de la página
    ...
    @Test
    public void testRegistrarseCorrectamenteUsuario(){//Solo se puede ejecutar una vez, hay que limpiar la base de datos
    	mary.beginAt("/login.jsp");
    	mary.assertTitleEquals("TaskManager - Inicie sesión");//comprobamos el nombre del titulo de la página
    	mary.assertTextPresent("Contraseña:");//comprobamos texto de la página
    	mary.assertTextPresent("Identificador de usuario:");//comprobamos texto de la página
    ...
    //	mary.clickLink("eliminar4");//Eliminamos una categoria
